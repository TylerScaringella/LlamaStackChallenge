...
const averageScore = useMemo(() => {
  ...
  const setCheckTrue = (selector: number) => {
    if (selector === 1) {
      setChecked1(true);
      setChecked2(false);
      setChecked3(false);
    ...
    console.log(`checked1: ${checked1}, checked2: ${checked2}, checked3: ${checked3}`);
  };
  ...
  return (
    <>
      ...
      <Container style={{ marginBottom: 60 }}>
        ...
        <TwoColumnLayout style={{ flexDirection: "column", marginTop: 10 }}>
           <LatoTitle style={{paddingTop: 0, fontSize: 21, color: colors.black, fontWeight: 700, margin: 5, marginLeft: 1}}>Gut-Check</LatoTitle>
           <HorizontalContainer style={{justifyContent: 'center'}}> 
            <GutCheckButton style={{backgroundColor: checked2 || checked3 ? "#86dd8339" : '#86dd83'}} onPress={() => setCheckTrue(1)}>
                <GutCheckButtonText style={{fontSize: 17 }}>Love it!</GutCheckButtonText>
            </GutCheckButton>
            <GutCheckButton style={{backgroundColor: checked1 || checked3 ? "#ecd38330" : '#ecd483'}} onPress={() => setCheckTrue(2)}>
                <GutCheckButtonText style={{fontSize: 17 }}>It's okay...</GutCheckButtonText>
            </GutCheckButton>
            <GutCheckButton style={{backgroundColor: checked1 || checked2 ? "#f3989837" : '#f39898'}} onPress={() => setCheckTrue(3)}>
                <GutCheckButtonText style={{fontSize: 17 }}>Not a fan.</GutCheckButtonText>
            </GutCheckButton>
           </HorizontalContainer> 
          </TwoColumnLayout>
        {(checked1 || checked2 || checked3) && (
          <>
            <GutCheckBubble style={{marginTop: 10}}>
              <LatoTitle style={{paddingTop: 0, fontSize: 21, color: colors.black, fontWeight: 700, margin: 5, marginLeft: 1}}>Journal</LatoTitle>
              <JournalItem>
          ...
          <GutCheckButtonText style={{fontSize: 20, color: 'white' }}>Rank</GutCheckButtonText>
              </GutCheckButton>
            </HorizontalContainer>
          </>
        )}
